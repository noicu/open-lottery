/* my-membership-cards-prod-aem-v1.2.71 */
define("text!service/my-membership-cards/activate-your-card/activate-your-card-modal.html", ["module"], function(e) {
    e.exports = '<template><require from="./activate-your-card-modal.css"></require><require from="../common-styles/membership-modals.css"></require><require from="elements/tatts-dialog/tatts-dialog"></require><require from="elements/radio-button/radio-button"></require><require from="elements/loading-button/loading-button"></require><tatts-dialog class="membership-modal activate-your-card-modal ${membershipNameCssClass} modal-with-my-membership-card-in-header" title="Activate your card" error-message.bind="errorMessage"><section class="select-membership"><div class="membership-options"><div repeat.for="option of options" class="option ${option === selectedOption ? \'selected\' : \'\'}"><div class="option-heading">${option.years} Year Membership</div><div class="option-details"><div class="option-price">${option.price | formatCurrency}</div><radio-button name="membershipOption" model.bind="option" checked.bind="selectedOption"></radio-button></div></div></div><input type="checkbox" name="physical-card-opt-in" id="opt-in-chcekbox" checked.bind="physicalCardOptIn"> <label for="opt-in-chcekbox" class="opt-in-label">Send me a physical card to use in-store to my <a href="/account/settings" target="_blank">postal address</a>.</label><p class="fine-print">By selecting the button below, your ${membershipDurationYears} Year ${membershipName} membership will be purchased and ${membershipDurationPrice | formatCurrency} will be debited from your online account balance.</p><loading-button class="purchase-button" button-clicked.call="purchase()">Buy ${membershipDurationYearsTextPluralised} - ${membershipDurationPrice | formatCurrency}</loading-button></section></tatts-dialog></template>'
}), define("text!service/my-membership-cards/link-an-existing-card/link-an-existing-card-modal.html", ["module"], function(e) {
    e.exports = '<template><require from="./link-an-existing-card-modal.css"></require><require from="elements/tatts-dialog/tatts-dialog"></require><require from="elements/loading-button/loading-button"></require><tatts-dialog title="Link an existing card" class="link-an-existing-card-modal ${membershipNameCssClass} modal-with-my-membership-card-in-header" error-header.bind="errorHeader" error-message.bind="errorMessage"><section class="link-card"><p data-test-id="instructions-info" class="instructions" if.bind="!showErrorInstructions">If you have an existing ${membershipNameCardText}, please enter your card number so that we can link it to your online account. Doing so will allow you to view your offline (retail store) purchases and prizes online.</p><p data-test-id="instructions-error" class="instructions" if.bind="showErrorInstructions">Check the number and try again, or call us on <b><a href="tel:131868">131 868</a></b> if you require assistance.</p><div class="card-number-container validation-container"><label data-test-id="card-number-label" for="cardNumber">${membershipNameCardText} number</label> <input id="cardNumber" type="text" value.bind="cardNumber & validate" maxlength="11" change.delegate="setCardNumber($event.target.value)" keyup.delegate="setCardNumber($event.target.value)" data-test-id="card-number-input"></div><loading-button class="link-card-button" button-clicked.call="linkCard()" data-test-id="link-existing-card-button">Link card</loading-button></section></tatts-dialog></template>'
}), define("text!service/my-membership-cards/renew-your-card/renew-your-card-modal.html", ["module"], function(e) {
    e.exports = '<template><require from="../common-styles/membership-modals.css"></require><require from="elements/tatts-dialog/tatts-dialog"></require><require from="elements/radio-button/radio-button"></require><require from="elements/loading-button/loading-button"></require><tatts-dialog class="membership-modal renew-your-card-modal ${membershipNameCssClass} modal-with-my-membership-card-in-header" title="Renew your card" error-message.bind="errorMessage"><section class="select-membership"><div class="membership-options"><div repeat.for="option of options" class="option ${option === selectedOption ? \'selected\' : \'\'}"><div class="option-heading">${option.years} Year Membership</div><div class="option-details"><div class="option-price">${option.price | formatCurrency}</div><radio-button name="membershipOption" model.bind="option" checked.bind="selectedOption"></radio-button></div></div></div><p class="fine-print">By selecting the button below, your ${membershipName} membership will be renewed for an additional ${membershipDurationYearsTextPluralised} and ${membershipDurationPrice | formatCurrency} will be debited from your online account balance.</p><loading-button class="purchase-button" button-clicked.call="purchase()">Renew for ${membershipDurationYearsTextPluralised} - ${membershipDurationPrice | formatCurrency}</loading-button></section></tatts-dialog></template>'
});
...
define("service/my-membership-cards/activate-card-service", ["require", "exports", "aurelia-framework", "services/tatts-http", "services/user-context", "errors/error-with-tatts-svc-error-info", "services/tatts-log", "services/tatts-event-service", "events/membership/index"], function(e, t, r, n, i, a, o, s, c) {
    "use strict";
...
define("service/my-membership-cards/handle-insufficient-funds-upon-activation", ["require", "exports", "service/credit-card-deposit/credit-card-dialog-service", "services/tatts-dialog-service", "errors/error-with-tatts-svc-error-info"], function(e, t, r, n, i) {
    "use strict";
    var a = this;
    Object.defineProperty(t, "__esModule", {
        value: !0
...
}), define("service/my-membership-cards/index", ["require", "exports"], function(e, t) {
    "use strict";
    Object.defineProperty(t, "__esModule", {
        value: !0
...
define("service/my-membership-cards/link-card-service", ["require", "exports", "aurelia-framework", "services/tatts-http", "services/user-context", "errors/error-with-tatts-svc-error-info", "services/tatts-event-service", "events/membership/index"], function(e, t, r, n, i, a, o, s) {
    "use strict";
    Object.defineProperty(t, "__esModule", {
        value: !0
    });
...
define("service/my-membership-cards/list-card-service", ["require", "exports", "aurelia-framework", "services/tatts-http", "services/user-context", "errors/error-with-tatts-svc-error-info"], function(e, t, r, n, i, a) {
    "use strict";
    Object.defineProperty(t, "__esModule", {
        value: !0
    });
    ...
    t.ListCardService = o
}), define("service/my-membership-cards/membership-options", ["require", "exports", "tatts-api/idata/lotteries-company"], function(e, t, r) {
    "use strict";
    Object.defineProperty(t, "__esModule", {
        value: !0
...
define("service/my-membership-cards/my-membership-card-modals-service", ["require", "exports", "./link-an-existing-card/link-an-existing-card-modal", "./activate-your-card/activate-your-card-modal", "aurelia-framework", "services/tatts-dialog-service", "./activate-card-service", "service/credit-card-deposit/credit-card-dialog-service", "./handle-insufficient-funds-upon-activation", "./renew-your-card/renew-your-card-modal", "services/user-context", "services/tatts-configuration"], function(e, t, r, n, i, a, o, s, c, l, u, d) {
    ...
    t.MyMembershipCardModalsService = p
});
var __decorate = this && this.__decorate || function(e, t, r, n) {
        var i, a = arguments.length,
            o = a < 3 ? t : null === n ? n = Object.getOwnPropertyDescriptor(t, r) : n;
...
define("service/my-membership-cards/my-membership-periods-service", ["require", "exports", "aurelia-framework", "services/tatts-http", "services/tatts-log", "tatts-api/idata/lotteries-company"], function(e, t, r, n, i, a) {
    "use strict";
    Object.defineProperty(t, "__esModule", {
        value: !0
    });
    ...
    var s = function() {
        ...
        return e.prototype.getRenewalOptions = function(e) {
            ...
            return __awaiter(this, void 0, void 0, function() {
                var t;
                return __generator(this, function(r) {
                    if (!e) return [2, Promise.resolve({})];
                    switch (e) {
                        case a.LotteriesCompany.GoldenCasket:
                        case a.LotteriesCompany.NSWLotteries:
                            t = 5;
                            break;
                        case a.LotteriesCompany.NTLotteries:
                            t = 7.7;
                            break;
                        case a.LotteriesCompany.SALotteries:
                            t = 5;
                            break;
                        case a.LotteriesCompany.Tattersalls:
                        default:
                            t = 7.7
                    }
    ...
    t.MyMembershipPeriodsService = s
});
...
}), define("service/my-membership-cards/common/sanitize-string", ["require", "exports"], function(e, t) {
    "use strict";
    Object.defineProperty(t, "__esModule", {
        value: !0
...
define("service/my-membership-cards/link-an-existing-card/link-an-existing-card-modal", ["require", "exports", "aurelia-framework", "aurelia-dialog", "aurelia-validation", "validation/validation-renderer", "services/user-context", "./refined-error-messages", "errors/error-with-tatts-svc-error-info", "../link-card-service", "../membership-options", "services/body-dialog", "../common/sanitize-string"], function(e, t, r, n, i, a, o, s, c, l, u, d, p) {
...
}), define("service/my-membership-cards/link-an-existing-card/refined-error-messages", ["require", "exports"], function(e, t) {
    "use strict";
    Object.defineProperty(t, "__esModule", {
        value: !0
    });
    var r, n, i = (r = {}, r[26] = (n = {}, n[771] = {
        title: "Hold on...",
        body: "That card has been cancelled.",
        useBodyDialog: !1
    }, n[772] = {
        title: "Hold on...",
        body: "That card has already been linked to your account.",
        useBodyDialog: !1
    }, n[770] = {
        title: "Hold on...",
        body: "That card cannot be linked to your online account as the card's membership details do not match.",
        useBodyDialog: !1
    }, n[757] = {
        title: "Hold on...",
        body: "That card cannot be linked to your online account as the card's membership details do not match.",
...
define("service/my-membership-cards/renew-your-card/renew-your-card-modal", ["require", "exports", "aurelia-framework", "services/user-context", "../membership-options", "../my-membership-periods-service", "../activate-card-service", "aurelia-dialog", "errors/error-with-tatts-svc-error-info", "services/tatts-format", "services/tatts-log"], function(e, t, r, n, i, a, o, s, c, l, u) {
    ...
    var d = function() {
        ...
        return e.prototype.activate = function() {
            ...
            enumerable: !0,
            configurable: !0
        }), __decorate([r.computedFrom("selectedOption"), __metadata("design:type", Object), __metadata("design:paramtypes", [])], e.prototype, "membershipDurationYearsTextPluralised", null), __decorate([r.computedFrom("selectedOption"), __metadata("design:type", Object), __metadata("design:paramtypes", [])], e.prototype, "membershipDurationPrice", null), e = __decorate([r.autoinject, __metadata("design:paramtypes", [n.UserContext, o.ActivateCardService, s.DialogController, a.MyMembershipPeriodsService, u.TattsLog])], e)
    }();
    t.RenewYourCardModal = d
}), define("text!service/my-membership-cards/activate-your-card/activate-your-card-modal.css", ["module"], function(e) {
    e.exports = "/**\n * Foundation for Sites by ZURB\n * Version 6.3.1\n * foundation.zurb.com\n * Licensed under MIT Open Source\n */\n.activate-your-card-modal .select-membership > label {\n  font-size: 0.875rem;\n  line-height: 1.25rem;\n  margin-bottom: 1.5rem;\n  margin-right: 0;\n  color: #444444;\n  vertical-align: top;\n  width: 256px; }\n"
}), define("text!service/my-membership-cards/common-styles/membership-modals.css", ["module"], function(e) {
...
}), define("text!service/my-membership-cards/link-an-existing-card/link-an-existing-card-modal.css", ["module"], function(e) {
    e.exports = "/**\n * Foundation for Sites by ZURB\n * Version 6.3.1\n * foundation.zurb.com\n * Licensed under MIT Open Source\n */\ntatts-dialog.link-an-existing-card-modal ux-dialog-header.error-dialog-header {\n  padding: 1rem 3rem 1rem 3rem; }\n\n.link-an-existing-card-modal .instructions {\n  font-size: 0.875rem;\n  line-height: 1.25rem;\n  color: #444444;\n  margin-bottom: 1.5rem; }\n\n.link-an-existing-card-modal .card-number-container {\n  margin-bottom: 2rem; }\n\n.link-an-existing-card-modal .link-card-button button {\n  width: 100%; }\n"
}), define("text!my-membership-cards-environment.json", ["module"], function(e) {
    e.exports = '{\n  "debug": false,\n  "testing": false,\n  "assetPath": "/etc/designs/the-lott/components/content/my-membership-cards/clientlibs/assets/",\n  "baseUrl": "https://thelott.com/",\n  "logLevel": 2\n}\n'
});